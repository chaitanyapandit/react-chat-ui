...
var ChatFeed = function (_React$Component) {
    ...
    _createClass(ChatFeed, [{
        ...
        value: function render() {
            ...
            var inputField = this.props.hasInputField && React.createElement(ChatInput_1.default, { inputStyles: {}, inputPlaceholder: "" });
            ...
            return React.createElement("div", { id: "chat-panel", style: styles_1.default.chatPanel }, React.createElement("div", { ref: function ref(c) {
                    _this2.chat = c;
                }, className: "chat-history", style: Object.assign(Object.assign({}, styles_1.default.chatHistory), { maxHeight: maxHeight }) }, React.createElement("div", { className: "chat-messages" }, this.renderMessages(this.props.messages))), inputField);
        }
    }]);
