...
var ChatBubble = function (_React$Component) {
    ...
    _createClass(ChatBubble, [{
        ...
        value: function render() {
            ...
            var chatBubbleStyles = this.props.message.id === 0 ? Object.assign(Object.assign(Object.assign({}, styles_1.default.chatbubble), bubblesCentered ? {} : styles_1.default.chatbubbleOrientationNormal), userBubble) : Object.assign(Object.assign(Object.assign(Object.assign({}, styles_1.default.chatbubble), styles_1.default.recipientChatbubble), bubblesCentered ? {} : styles_1.default.recipientChatbubbleOrientationNormal), chatbubble);
            var bubbleText = this.props.message.id === 0 ? userBubble.text ? userBubble.text : text : chatbubble.text ? chatbubble.text : text;
            return React.createElement("div", { style: Object.assign({}, styles_1.default.chatbubbleWrapper) }, React.createElement("div", { style: chatBubbleStyles }, React.createElement("p", { style: Object.assign(Object.assign({}, styles_1.default.p), bubbleText) }, this.props.message.message)));
        }
    }]);
